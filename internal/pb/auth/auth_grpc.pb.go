...
const (
	...
	AuthService_CheckOtp_FullMethodName     = "/auth.AuthService/CheckOtp"
...
func (c *authServiceClient) CheckOtp(ctx context.Context, in *CheckOtpRequest, opts ...grpc.CallOption) (*CheckOtpResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckOtpResponse)
	err := c.cc.Invoke(ctx, AuthService_CheckOtp_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) CheckOtp(context.Context, *CheckOtpRequest) (*CheckOtpResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckOtp not implemented")
}
...
func _AuthService_CheckOtp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckOtpRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).CheckOtp(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_CheckOtp_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).CheckOtp(ctx, req.(*CheckOtpRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CheckOtp",
			Handler:    _AuthService_CheckOtp_Handler,
		},
		{
			MethodName: "Me",
